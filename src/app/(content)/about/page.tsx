  ...
  return (
    <main className="flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="absolute h-screen flex flex-col justify-center items-left md:mx-10 lg:mx-40 z-10">
          <div className="flex flex-row justify-content items-center gap-x-4">
            ...
            <h4 className="uppercase text-xl font-medium tracking-wide leading-6 lg:leading-12 lg:text-xl bg-gradient-to-br from-slate-500 to-slate-700 dark:bg-gradient-to-br dark:from-slate-300 dark:to-slate-500 inline-block text-transparent bg-clip-text">About Me</h4>
          </div>
          <TextGenerateSection />
        </div>
      </div>
      ...
      <div className="flex flex-col md:m-20 lg:mx-40 gap-y-12 ">
        <h2 className="bg-gradient-to-br from-slate-500 to-slate-700 dark:bg-gradient-to-br dark:from-slate-300 dark:to-slate-500 pb-2 inline-block text-transparent bg-clip-text md:text-3xl lg:text-6xl tracking-wide">This is my story — <br /> alongside some flicks from my recent trip to Himachal Pradesh.</h2>
      ...
      <div className="flex flex-col justify-center items-center sm:gap-y-4 md:gap-y-8 lg:gap-y-16 md:mx-10 lg:mx-60 my-20">
        <div className="flex flex-col gap-y-4">
          <h2 className="text-3xl text-center tracking-wide leading-6 lg:leading-12 lg:text-5xl bg-gradient-to-br from-slate-500 to-slate-700 dark:bg-gradient-to-br dark:from-slate-300 dark:to-slate-500 inline-block text-transparent bg-clip-text">Here's what my friends & colleagues say about me</h2>
