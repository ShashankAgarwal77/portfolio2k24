...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative lg:rounded-full lg:border lg:border-slate-200 lg:dark:bg-black/[0.8] lg:dark:border-white/[0.2] lg:bg-white shadow-input flex justify-center lg:px-6 lg:py-2"
    >
      {children}
    </nav>
  );
