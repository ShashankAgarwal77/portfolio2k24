                    ...
                    <div className="hero-content--wrapper absolute inset-0">
                        <div className="flex flex-col mx-4 md:mx-20 lg:mx-40 justify-center items-center h-screen">
                            <div className="flex flex-col gap-y-4 md:gap-y-6 justify-center items-center" data-aos="fade-up">
                                ...
                                <p className="max-w-2xl leading-relaxed text-lg md:text-xl text-slate-600 dark:text-slate-400 z-1 tracking-wide text-center text-balance">
                                ...
                                <div className="flex flex-wrap gap-4 justify-center items-center my-4">
                                    <a href="https://www.linkedin.com/in/shashank-agarwal11/" target="_blank" rel="noopener noreferrer">
                                        <button className="bg-slate-100 dark:bg-slate-800 no-underline group cursor-pointer relative rounded-full p-px text-xs font-semibold leading-6 text-white inline-block shadow-xl">
                                            <span className="absolute inset-0 overflow-hidden rounded-full">
                                                <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                                            </span>
                                            <div className="relative flex px-4 py-2 md:px-6 md:py-4 text-lg md:text-xl justify-center z-10 rounded-full border border-slate-300 dark:border-none dark:bg-zinc-950 ring-1 ring-white/10 text-slate-900 dark:text-white">
                                                Let&apos;s connect
                                            </div>
