...
const testimonials = [
  {
    quote:
      "As a fellow designer, I've seen his talent firsthand — his craft consistently delivers.",
    name: "Pragadeesh K.",
  ...
  {
    quote:
      "A pleasure to work with. His creativity and eye for detail make every collaboration a high-quality one.",
    name: "Manikandan L.",
    title: "Product Designer",
  ...
  {
    quote:
      "Shashank turns ideas into visually captivating products. Excited to see where he goes next.",
    name: "Harsh Gupta",
  ...
  {
    quote:
      "Genuinely dedicated and passionate about design — he's carved out a real place in the field.",
  ...
  {
    quote:
      "A positive force on any design team. Working with him is a joy — and the work shows it.",
