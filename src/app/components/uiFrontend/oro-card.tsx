...
export function OroCard() {
  return (
    <div className="sm:mx-10 md:mx-20 lg:mx-60">
      <CardContainer
        className="inter-var"
      ...
      >
        <CardBody className="bg-gray-50 px-12 py-8 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl border hover:border-slate-600 mx-auto">
          <CardItem
            translateZ="10"
            className="sm:text-lg md:text-2xl lg:text-4xl font-bold tracking-wide leading-relaxed text-neutral-600 dark:text-white"
          >
          ...
          <CardItem
            as="p"
            translateZ="10"
            className="text-neutral-500 sm:text-sm md:text-lg lg:text-3xl my-4 mb-8 dark:text-neutral-500 tracking-wide"
          >
          ...
          <CardItem
            as="p"
            translateZ="10"
            className="text-neutral-500 sm:text-sm md:text-lg lg:text-2xl my-4 mb-8 dark:text-neutral-400 tracking-wide"
          >
            Key Takeaways : <br />
