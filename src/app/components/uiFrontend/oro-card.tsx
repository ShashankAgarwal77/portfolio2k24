      ...
      >
        <CardBody className="bg-gray-50 px-12 py-10 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl border hover:border-slate-600 mx-auto">
          ...
          <CardItem
            as="p"
            translateZ="10"
            className="text-neutral-500 sm:text-sm md:text-lg lg:text-2xl my-4 mb-8 dark:text-neutral-500 tracking-wide"
          >
          ...
          <CardItem
            as="p"
            translateZ="10"
            className="text-neutral-500 sm:text-sm md:text-lg lg:text-xl my-4 mb-8 dark:text-neutral-400 tracking-wide"
          >
            Key Takeaways : <br />
